...
describe('NativeBalanceChange', () => {
  ...
  describe('decodeNativeBalanceChangeTerms', () => {
    ...
    it('decodes increase balance change', () => {
      ...
      const decoded = decodeNativeBalanceChangeTerms(
    ...
    it('accepts Uint8Array terms from the encoder', () => {
      ...
      const bytes = createNativeBalanceChangeTerms(original, { out: 'bytes' });
      const decoded = decodeNativeBalanceChangeTerms(bytes);
