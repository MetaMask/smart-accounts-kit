...
describe('resolveCaveats', () => {
  ...
  describe('when caveats is a CaveatBuilder', () => {
    ...
    it('should handle CoreCaveatBuilder with named caveats using enum', () => {
    ...
    it('should handle CoreCaveatBuilder with named caveats using string literal', () => {
      const caveatBuilder = createCaveatBuilder(environment, {
        allowInsecureUnrestrictedDelegation: true,
      });
  ...
  describe('when caveats is an array', () => {
    ...
    it('should resolve caveats from an array of CaveatConfiguration objects with string types', () => {
    ...
    it('should resolve caveats from an array of CaveatConfiguration objects with enum types', () => {
      const caveatConfigs: CoreCaveatConfiguration[] = [
        {
